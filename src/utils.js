...
exports.generateProof = exports.getMerkleProof = exports.Bits2Num = exports.parseProof = void 0;
var fs = require("fs");
...
function generateProof(contract, cmtIdx, param) {
    return __awaiter(this, void 0, void 0, function () {
        var poseidonHash, _a, merklePath, path2RootPos2, root, i, input, wasm, zkey, wc, buffer, witnessCalculator, witnessBuffer, _b, proof, publicSignals, _c, a, b, c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, cls.buildPoseidonReference()];
                case 1:
